$.sources = {
  ...
  format: function(service) {
    ...
    return "<img class='service-icon' src='" + __scribe_path__ + "/assets/img/papyrus.png')/>" + service.text;
  },
  ...
  load: function() {
    ...
    $.get("scribe/sources", function(data) {

      services = data.services;
      $.service_selector.services = services;
